...
function __OriginkitBase_ParticleText(props) {
...
const COMPONENT_DEFAULTS = {
    ...
    transition: {
        ...
        type: "tween",
        delay: 0,
        duration: 2.2, // set duration for smooth transition animation
    },
};
...
export default function ParticleText(props) {
  return <__OriginkitBase_ParticleText {...__originkitPresetProps} {...props} />;
}
